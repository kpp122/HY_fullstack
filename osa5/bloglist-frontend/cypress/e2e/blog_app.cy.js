describe('Blog app', function () {
  beforeEach(function () {
    ...
    cy.request('POST', 'http://localhost:3001/api/users',
      { username: 'root', name: 'superuser', password: 'secret' })
  ...
  describe('login', function () {
    ...
    describe('when logged in', function () {
      ...
      describe('and a blog exists', function () {
        beforeEach(function () {
          cy.createBlog({ title: 'Cypress testing', author: 'whoever', url: 'localhost:3000', likes: 12 })
          cy.createBlog({ title: 'react testing', author: 'badauthor', url: 'localhost:3000', likes: 50 })
          cy.createBlog({ title: 'jest testing', author: 'good', url: 'localhost:3000', likes: 49 })
        })

        it('a blog can be liked', function () {
          cy.contains('Cypress testing').parent().as('parentDiv')
          cy.get('@parentDiv')
            .find('#blog-visibilityButton').click()
          cy.get('@parentDiv')
            .find('#blog-likeButton').click()
        })
